      ...
      rounded-lg">
        <form onSubmit={handlerSubmit} className='flex flex-col gap-5 p-10 flex-1'>
             ...
             <label htmlFor='avatar' className='flex items-center gap-3 cursor-pointer'>
              <input onChange={(e)=>setSelectedImg(e.target.file[0])} type='file' id='avatar' accept='.png , .jpg, .jpeg' hidden/>
             ...
             <input value={name} onChange={(e)=>setName(e.target.value)}
              ...
              className='p-2 border boeder-gray-500 rounded-md focus:outline-none focus:ring-2
              focus: ring-violet-500'/>
              <textarea value={bio} onChange={(e)=>setBio(e.target.value)} placeholder='Write profile bio' className='p-2 border border-gray-500
               rounded-md focus:outline-none focus:ring-2
               focus:right-violet-500' rows={4} required></textarea>
        ...
        <img className='max-w-42 aspect-square rounded-full max-10 max-sm:mt-10 ' src={assets.logo_icon} alt='' />
      </div>
